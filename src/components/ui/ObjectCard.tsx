...
export function ObjectCard({
  ...
  return (
    <motion.div
      ...
      transition={{ type: 'spring', stiffness: 400, damping: 28 }}
      onClick={onClick}
      className={`group relative p-5 rounded-[26px] cursor-pointer overflow-hidden select-none ${
        isDark
          ? 'bg-[#0B0C11] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),inset_0_0_0_1px_rgba(255,255,255,0.02),0_18px_40px_-10px_rgba(0,0,0,0.65)] hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_22px_48px_-10px_rgba(0,0,0,0.8)]'
          : 'bg-white shadow-[inset_0_1px_0_0_rgba(255,255,255,0.95),0_4px_20px_rgba(0,0,0,0.03)] border border-black/[0.035] hover:border-black/[0.08] hover:shadow-[0_8px_28px_rgba(0,0,0,0.05)]'
      ...
      <div className="flex items-start gap-3">
        ...
        {isHabit && (
          <button
            ...
            className="mt-0.5 w-7 h-7 rounded-full bg-orange-500/15 hover:bg-orange-500/25 text-orange-500 flex items-center justify-center shrink-0 transition-transform active:scale-95 border border-orange-500/20 shadow-[0_0_8px_rgba(249,115,22,0.3)]"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 flex-wrap mb-1">
            ...
            {isHabit && object.metadata?.streak !== undefined && (
              <span className={`text-[10px] font-semibold ml-auto flex items-center gap-1 ${isDark ? 'text-zinc-300' : 'text-zinc-600'}`}>
          ...
          <h4
            className={`text-sm font-semibold tracking-tight leading-snug break-words ${
              isDark ? 'text-zinc-100 group-hover:text-white' : 'text-zinc-950 font-semibold'
